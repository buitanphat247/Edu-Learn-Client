  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {Array.from({ length: 18 }).map((_, i) => (
        <div
          key={i}
          className="group relative bg-[#1e293b] rounded-3xl overflow-hidden shadow-lg flex flex-col h-full border border-slate-700 animate-pulse"
        >
          {/* Side Accent Line */}
          ...
          <div className="p-6 pl-8 flex-1 flex flex-col relative z-10">
            ...
            <div className="mb-4 space-y-2">
              <div className="h-6 w-full bg-slate-700 rounded-md"></div>
