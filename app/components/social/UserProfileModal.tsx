        ...
        <div className="flex flex-col relative">
            ...
            <div className="px-6 pb-8 -mt-12 flex flex-col items-center">
                ...
                <div className="relative mb-4">
                    <div className="rounded-full p-1 bg-[#0f172a]">
                        <Avatar 
                            src={user.avatar} 
                            size={100} 
                            className="border-4 border-[#0f172a] bg-slate-700 font-bold text-4xl"
                        >
                ...
                <div className="flex items-center gap-2 mb-2">
                  <p className="text-slate-400 mb-0">@{user.username}</p>
                ...
                {user.role?.role_name && (
                  <div className={`px-3 py-1 rounded-full text-xs font-bold border uppercase tracking-wide mb-6 ${
                    user.role.role_name.toLowerCase().includes('admin') || user.role.role_name.toLowerCase().includes('quản trị')
                ...
                <div className="w-full">
                     {isSelf ? (
                        <div className="bg-slate-800/50 p-2 rounded-xl text-center text-slate-400 text-sm border border-slate-800">
