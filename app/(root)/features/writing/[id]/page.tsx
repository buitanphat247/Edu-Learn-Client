                      ...
                      {memoizedVietnameseSentences.map((sentence, index) => {
                        ...
                        return (
                          <div key={index} className="flex w-full justify-start">
                            ...
                            >
                              <div
                                className={`text-base leading-relaxed wrap-break-word font-medium ${
                                  isActive ? "text-slate-800 dark:text-slate-100" : isCompleted ? "text-slate-600 dark:text-slate-300" : "text-slate-400 dark:text-slate-500"
                                }`}
                              >
                                <span
                                  className={`text-sm font-bold mr-2 ${
                                    isActive ? "text-blue-600 dark:text-blue-400" : isCompleted ? "text-emerald-600 dark:text-emerald-500" : "text-slate-500 dark:text-slate-600"
                                  }`}
                                >
                                  {speaker}:
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              <div className="pb-1">
                <Button
                  ...
                  className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 border-0 shadow-lg shadow-blue-600/30 hover:shadow-blue-600/50 hover:scale-110 active:scale-95 transition-all w-12 h-12 flex items-center justify-center p-0"
                />
              </div>
            </div>
          </div>
