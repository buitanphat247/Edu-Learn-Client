    ...
    <section className="relative overflow-hidden bg-[#fafbfc] dark:bg-[#0f172a] pt-20 pb-32 transition-all duration-500 ease-in-out">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-slate-900 via-blue-800 to-blue-600 dark:from-white dark:via-blue-100 dark:to-blue-200 mb-8 leading-tight tracking-tight">
