            ...
            children: (
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-base font-bold text-gray-800">Định dạng PHẦN trong đề thi</h3>
                </div>
                ...
                <div className="ml-11 bg-pink-50 border-l-4 border-red-500 rounded p-3">
                  <p className="text-sm font-semibold text-red-600 mb-2">Ví dụ:</p>
              ...
              <div className="space-y-6">
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-base font-bold text-gray-800">Xác định câu hỏi</h3>
                  </div>
                  <p className="text-sm text-gray-700 ml-11">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-base font-bold text-gray-800">Xác định đáp án</h3>
                  </div>
                  <div className="ml-11 space-y-3">
                    <div>
                      ...
                      <div className="bg-pink-50 border-l-4 border-red-500 rounded p-3">
                        <p className="text-sm font-semibold text-red-600 mb-2">Ví dụ:</p>
                        <ul className="text-sm text-gray-700 space-y-1 list-disc list-inside">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-red-600 mb-2">Phần đúng sai:</p>
                      <p className="text-sm text-gray-700 mb-2">Sử dụng chữ cái thường + dấu ngoặc đơn + khoảng trắng</p>
                      <div className="bg-pink-50 border-l-4 border-red-500 rounded p-3">
                        <p className="text-sm font-semibold text-red-600 mb-2">Ví dụ:</p>
                        <ul className="text-sm text-gray-700 space-y-1 list-disc list-inside">
                          <li>a) Nhận định 1...</li>
              ...
              <div className="space-y-6">
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-base font-bold text-gray-800">Phần I (Nhiều phương án lựa chọn)</h3>
                  </div>
                  <p className="text-sm text-gray-700 ml-11">Gạch chân hoặc tô màu khác loại đáp án đúng.</p>
                  <div className="ml-11 bg-pink-50 border-l-4 border-red-500 rounded p-3">
                    <p className="text-sm font-semibold text-red-600 mb-2">Ví dụ:</p>
                    <ul className="text-sm text-gray-700 space-y-1 list-disc list-inside">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-base font-bold text-gray-800">Phần II (Đúng sai)</h3>
                  </div>
                  <p className="text-sm text-gray-700 ml-11">Chỉ gạch chân, không tô màu để xác định đáp án đúng.</p>
                  <div className="ml-11 bg-pink-50 border-l-4 border-red-500 rounded p-3">
                    <p className="text-sm font-semibold text-red-600 mb-2">Ví dụ:</p>
                    <ul className="text-sm text-gray-700 space-y-1 list-disc list-inside">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-base font-bold text-gray-800">Phần III (Trả lời ngắn hoặc tự luận có duy nhất một kết quả, đáp án)</h3>
                  </div>
                  <p className="text-sm text-gray-700 ml-11">Sử dụng chữ cái in hoa + dấu chấm + khoảng trắng để xác định kết quả đúng.</p>
                  <div className="ml-11 bg-pink-50 border-l-4 border-red-500 rounded p-3">
                    <p className="text-sm font-semibold text-red-600 mb-2">Ví dụ:</p>
                    <ul className="text-sm text-gray-700 space-y-1 list-disc list-inside">
                      <li>A. 22,4</li>
              ...
              <div className="space-y-6">
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-base font-bold text-gray-800">Đề thi Tiếng Anh</h3>
                  </div>
                  <p className="text-sm text-gray-700 ml-11">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-base font-bold text-gray-800">Định dạng, xác định PHẦN</h3>
                  </div>
                  <p className="text-sm text-gray-700 ml-11">
                    Đặt các thẻ <strong>&lt;g&gt;</strong> trước các phần trong đề. Một phần được định nghĩa là gồm Yêu cầu ở phía trên và danh sách câu
                    hỏi phục vụ cho yêu cầu đó ở phía dưới.
                  </p>
                  <div className="ml-11 bg-pink-50 border-l-4 border-red-500 rounded p-3">
                    <p className="text-sm font-semibold text-red-600 mb-2">Ví dụ:</p>
                    <ul className="text-sm text-gray-700 space-y-1 list-disc list-inside">
                      ...
                      <li>
                        Nếu muốn giữ nguyên vị trí của phần nào đó thì thầy cô chỉ cần thêm dấu <strong>#</strong> ngay trước <strong>&lt;g&gt;</strong> ví
                        dụ như: <strong>&lt;#g0&gt;</strong>, <strong>&lt;#g1&gt;</strong>, <strong>&lt;#g2&gt;</strong>, <strong>&lt;#g3&gt;</strong>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-base font-bold text-gray-800">Tính chất trộn các câu hỏi và đáp án trong 1 phần</h3>
                  </div>
                  <p className="text-sm text-gray-700 ml-11">
                  ...
                  <div className="ml-11 bg-pink-50 border-l-4 border-red-500 rounded p-3">
                    ...
                    <ul className="text-sm text-gray-700 space-y-1 list-disc list-inside">
                      ...
                      <li>
                        <strong>&lt;#g1&gt;</strong>: Giữ nguyên vị trí phần trong đề + hoán vị các câu hỏi, giữ nguyên vị trí các đáp án trong câu hỏi.
                      </li>
                      <li>
                        <strong>&lt;#g2&gt;</strong>: Giữ nguyên vị trí phần trong đề + hoán vị các đáp án trong câu hỏi, vị trí các câu hỏi trong phần
                        được giữ nguyên.
                      </li>
                      <li>
              ...
              <div className="space-y-4">
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-sm font-bold text-gray-800">Thiếu (.), (:), ")" và khoảng trắng</h3>
                  </div>
                  <p className="text-sm text-gray-700 ml-11">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-sm font-bold text-gray-800">Để tất cả các hình ảnh dưới dạng In Line with Text</h3>
                  </div>
                  <p className="text-sm text-gray-700 ml-11">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-sm font-bold text-gray-800">Lỗi trong quá trình định dạng đáp án đúng</h3>
                  </div>
                  <p className="text-sm text-gray-700 ml-11">
                    Khi sử dụng màu để xác định đáp án đúng, thầy cô cần đảm bảo màu của đáp án đúng là duy nhất và khác biệt so với các đáp án sai khác.
                  </p>
                </div>
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-sm font-bold text-gray-800">Thiếu xuống dòng</h3>
                  </div>
                  <p className="text-sm text-gray-700 ml-11">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-sm font-bold text-gray-800">Loại bỏ các định dạng lạ, thừa</h3>
                  </div>
                  <p className="text-sm text-gray-700 ml-11">
                    Để tránh những lỗi nhận dạng, thầy cô cần loại bỏ các định dạng lạ, định dạng ảnh hưởng trực tiếp đến các "từ khóa" quan trọng trong đề
                    trộn.
                  </p>
                </div>
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-sm font-bold text-gray-800">Loại bỏ các phông chữ, kiểu chữ lạ</h3>
                  </div>
                  <p className="text-sm text-gray-700 ml-11">
                    Để tránh việc hiển thị phông chữ, kiểu chữ (Styles) xấu, sai lệch trong đề sau khi trộn ra thì nên sử dụng phông Times New Roman và
                    kiểu chữ Normal.
                  </p>
                </div>
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-sm font-bold text-gray-800">Loại bỏ định dạng bảng (Table) không đúng vị trí</h3>
                  </div>
                  <p className="text-sm text-gray-700 ml-11">
