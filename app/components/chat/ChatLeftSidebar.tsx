...
import type { ChatParticipant } from "@/interface/chat";
          ...
          {participants.map((participant) => (
            ...
            >
              <Badge dot={participant.isOnline} color="green" offset={[-2, 2]}>
                <Avatar size={40} icon={<UserOutlined />} src={participant.avatar || undefined} className="bg-linear-to-br from-blue-400 to-purple-400">
