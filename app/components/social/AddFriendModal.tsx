...
export default function AddFriendModal({ open, onClose }: AddFriendModalProps) {
  ...
  return (
    <>
      ...
      >
            <div className="bg-[#1e293b] rounded-2xl overflow-hidden border border-slate-700 shadow-2xl p-5 text-slate-200">
                 {/* Header */}
                <div className="flex items-center justify-between mb-5">
                    <h2 className="font-bold text-white leading-none mb-0 tracking-tight text-base">Thêm bạn bè</h2>
                    <button
                        type="button"
                        onClick={onClose}
                ...
                <div className="flex gap-1 mb-4 bg-slate-800/50 p-1 rounded-xl">
                    <button
                        ...
                        className={`flex-1 py-2 px-2 rounded-lg text-sm font-medium transition-all cursor-pointer border-none ${
                            inputType === "phone" 
                ...
                <div className="mb-6">
                    {inputType === "phone" ? (
                        <div className="flex bg-slate-800 rounded-xl border border-slate-700 focus-within:border-blue-500 focus-within:ring-1 focus-within:ring-blue-500/50 transition-all">
                            <div className="flex items-center px-3 border-r border-slate-700/50 bg-slate-800/50 rounded-l-xl">
                                <span className="text-slate-400 text-sm font-medium">VN</span>
                                <span className="text-slate-300 ml-1 text-sm">+84</span>
                            </div>
                            <input
                                type="tel"
                                value={phoneNumber}
                                ...
                                autoFocus
                                className="flex-1 bg-transparent border-none py-3 px-3 text-white placeholder-slate-500 focus:outline-none text-sm"
                            />
                        </div>
                    ) : (
                        <div className="flex bg-slate-800 rounded-xl border border-slate-700 focus-within:border-blue-500 focus-within:ring-1 focus-within:ring-blue-500/50 transition-all">
